...
from run_finetuning_roc_curve import run_finetuning_function
...
for index in range(num_repetitions):
    output_filename = 'experiments_after_review/ri_roc_CNN6_fase_2' + '_' + str(index) + '.txt'
    model_save_path = 'saved_models/model_roc_CNN6_' + '_' + str(index) + '.ckpt'
