...
from engine_finetune_ri import train_one_epoch, evaluate #, train_one_epoch_av, evaluate_av
from classification_ri.dataset import SpiraDataset, DistributedWeightedSampler, DistributedSamplerWrapper
from timm.models.vision_transformer import PatchEmbed

from torch.utils.data import WeightedRandomSampler

from classification_ri.utils.generic import load_config
...
def main(args):
    ...
    if not args.audio_exp:
        ...
        target_length = {'audioset':1024, 'k400':1024, 'esc50':512, 'speechcommands':128, 'spira': 1024, 'spira_2': 1024} #spira should be 398. model may not work with pretrained checkpoint
        ...
        dataset_val = SpiraDataset(dataset_csv=args.data_eval, audio_conf=audio_conf_val, folder_path = args.data_path,
                                        use_fbank=args.use_fbank, fbank_dir=args.fbank_dir, 
    ...
    model_save_path='ri_finetune_mae.ckpt'
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if epoch >= args.first_eval_ep:
            ...
            if max_acc < test_stats["acc"]:
                max_acc = test_stats["acc"]
                torch.save({
